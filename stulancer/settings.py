"""
Django settings for stulancer project.
...
SECRET_KEY = 'django-insecure-7=xygwdhxwf(2%px*pgn#cxj7nw0)%0*$d#*wz)b24+d*vw1n('
...
THUMBNAIL_ALIASES = {
    '': {
        ...
        'thumbnail': {'size': (30, 50), 'crop': True},
